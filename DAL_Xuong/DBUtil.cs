...
namespace DAL_PolyCafe
{
    public class DBUtil
    {
        public static string connString = @"Data Source=DESKTOP-J3NDM9B\SQLEXPRESS;Initial Catalog=PRO_QuanLyThuVien;Integrated Security=True;Trust Server Certificate=True";
